...
public enum Cake {
    YELLOW_BUTTER_CAKE("yellow butter cake",1, 5000, 2000, 4000, 6000),
    POUND_CAKE("pound cake", 2, 3000,3000, 3000, 6000),
    RED_VELVET_CAKE("red velvet cake", 3,2000, 5000, 6000, 6000),
    CARROT_CAKE("carrot cake", 4, 3000,3000, 5000, 6000),
    SPONGE_CAKE("sponge cake",5, 6000,2000, 3000, 6000),
    GENOISE_CAKE("genoise cake",6, 3000,5000, 2000, 6000),
    CHIFON_CAKE("chiffon cake",7, 4000,4000, 4000, 6000),
    FLOURLESS_CAKE("flourless cake",8,2000, 2000, 2000, 6000),
    ...
    SIMPLE_CAKE("simple cake",12, 1000,1000, 1000, 10000);
